 ...
 */
public class SilhouettePlotFrame extends javax.swing.JFrame {

    protected double scale;
    protected int originalW;
    protected int originalH;
    protected int originalElemDist;
    public final double SCROLL_AMOUNT = 0.1;
    ...
    //supported vertical Scaling Types (copied from GraphicArea.java)
    ...
    public SilhouettePlotFrame(ArrayList<ArrayList<Integer>> matrix, ArrayList<Double> densities, Integer maxClusterID, Color[] colors) {
    ...
    private void initComponents() {
        ...
        this.scale = 1;
        p_GraphicArea = new SilhouetteGraphic(this.matrix, this.densities, this.maxClusterID, "Silhouette", this.colors, this.originalElemDist);
        ...
        p_GraphicArea.setPreferredSize(new java.awt.Dimension(this.originalW, this.originalH-80));
    ...
    private void updateScale()
    {
        ...
        else
        {
            ...
            //repainting
            this.p_GraphicArea.setVisible(true);
            //repaint();
        }
    }
    ...
    private void b_zoomInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_zoomInActionPerformed
        ...
        this.p_GraphicArea.increaseHs();
        
        if(this.p_GraphicArea.getHs() < 100)
        {
            this.scale = 1;
        }
   ...
   public void resetZoom(KeyEvent e)
    ...
    private SilhouetteGraphic p_GraphicArea;
