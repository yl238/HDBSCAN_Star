 ...
 */
public class SilhouetteHSamplingBGraphic extends SilhouetteGraphic{
    
    private int skip;
    
    public SilhouetteHSamplingBGraphic(ArrayList<ArrayList<Integer>> matrix, ArrayList<Double> densities, Integer maxClusterID, String yLabel, Color[] colors, int k, int elemDist) {        
    ...
    @Override
    //Prints only the multiples of skip.
